...
function css(){if(document.querySelector('#h3libcss'))return;const s=document.createElement('style');s.id='h3libcss';s.textContent='.h3lib-btn{margin-top:8px;padding:9px 10px!important}.h3lib-modal{position:fixed;inset:0;background:#000c;z-index:80;padding:18px;overflow:auto;box-sizing:border-box}.h3lib-box{width:100%;max-width:720px;margin:5vh auto;background:#171a21;border:1px solid #2b3240;border-radius:16px;padding:14px;box-sizing:border-box;overflow-x:hidden}.h3lib-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;width:100%}.h3lib-item{background:#11151c;border:1px solid #2b3240;border-radius:12px;padding:7px;min-width:0}.h3lib-item img{max-width:100%;width:100%;aspect-ratio:1;object-fit:cover;border-radius:8px}.h3lib-item .name{font-size:10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin:5px 0}.h3lib-item button{width:100%;padding:7px;margin-top:4px;box-sizing:border-box}.h3lib-tabs{display:flex;gap:6px;margin:8px 0 12px;flex-wrap:wrap}@media(max-width:460px){.h3lib-grid{grid-template-columns:repeat(2,1fr)}.h3lib-box{padding:10px}}';document.head.appendChild(s);}
